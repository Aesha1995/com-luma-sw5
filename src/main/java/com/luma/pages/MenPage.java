...
public class MenPage extends Utility {
    ...
    public void mouseHoverOnCronusYogaPant() {
        CustomListeners.test.log(Status.PASS,"Mouse hover on cronus pant"+cronusYogaPant);
        mouseHoverToElement(cronusYogaPant);
    }
    public void clickOnSize() {
        CustomListeners.test.log(Status.PASS,"Click on Size"+size);
        clickOnElement(size);
    }
    public void clickOnColor() {
        CustomListeners.test.log(Status.PASS,"Click on color"+color);
    ...
    public String getTextAfterAddToCart() {
        CustomListeners.test.log(Status.PASS,"Get text from Add to Cart"+addToCartText);
